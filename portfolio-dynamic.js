    ...
    loadCorrectProjects() {
        ...
        this.latestProjects = [
            ...
            },
            {
                ...
                images: [
                    { filename: 'first-image.png', path: 'assets/images/latest-portfolio/resume-builder/first-image.png' },
                    { filename: 'second-image.png', path: 'assets/images/latest-portfolio/resume-builder/second-image.png' },
                    { filename: 'third-image.png', path: 'assets/images/latest-portfolio/resume-builder/third-image.png' },
                    { filename: 'fourth-image.png', path: 'assets/images/latest-portfolio/resume-builder/fourth-image.png' }
                ],
                github_url: 'https://github.com/Bilal-986/open-resume',
                description: 'A modern resume builder application with drag-and-drop functionality and professional templates. Built with React and modern web technologies, featuring real-time preview, export options, and customizable layouts for creating stunning resumes.'
            }
        ];
